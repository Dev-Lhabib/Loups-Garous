    ...
    <div class="w-full max-w-sm mx-auto text-center space-y-8">
        ...
        <div class="space-y-4">
            <div class="flex items-center justify-center gap-2">
                <div class="w-2 h-2 bg-accent-gold rounded-full animate-pulse animation-delay-200"></div>
                <div class="w-2 h-2 bg-accent-gold rounded-full animate-pulse animation-delay-400"></div>
                <div class="w-2 h-2 bg-accent-gold rounded-full animate-pulse animation-delay-600"></div>
            </div>
